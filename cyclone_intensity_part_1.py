# -*- coding: utf-8 -*-
"""Cyclone Intensity Part 1

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1Gq2xUGCvYvkFXX3CZJyPnAZdYeG8rhMd
"""
...
model = tf_keras.models.load_model('/content/drive/MyDrive/major_project/Trained_model1.h5')
model
...
# Define a function to predict cyclone intensity
def predict_cyclone_intensity(latitude, longitude, region):
    # Preprocess input features (if necessary)
    # Make predictions using the pre-trained model
    # Replace this with your prediction logic
    intensity = model.predict([[latitude, longitude, region]])[0]
    return intensity

# Create Gradio interface
iface = gr.Interface(
    fn=predict_cyclone_intensity,
    inputs=["number", "number", "text"],  # Latitude, Longitude, Region
    outputs="text",  # Cyclone Intensity
    title="Cyclone Intensity Predictor",
    description="Enter latitude, longitude, and region to predict cyclone intensity."
)
...
# prompt: create a user interface for this whole code and predict the output and take the input as an image
